...
One .NET application separates API wiring, scan orchestration, provider parsing, assessment, and PostgreSQL persistence through ordinary files and methods. The provider and scan-store interfaces allow offline tests without adding deployment layers.
